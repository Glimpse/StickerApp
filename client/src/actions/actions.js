export const AUTH_ACTIONS = Object.freeze({
    GET_PROFILE_REQUEST_ACTION: 'GET_USER_PROFILE_REQUEST_ACTION',
    GET_PROFILE_SUCCESS_ACTION: 'GET_USER_PROFILE_SUCCESS_ACTION',
    GET_PROFILE_FAILED_ACTION: 'GET_USER_PROFILE_FAILED_ACTION'
});
